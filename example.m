...
nSubcarriers    = 120;                  % used subcarriers
mSymbols        = 28;                   % used symbols
lagN            = 16;                   % size of subarrays for rows
...
maxOrder = numScatterers + 1;
% ----------------
music2D         = MUSIC2D(nSubcarriers, mSymbols, lagN, lagM, ...
                    dSearchSpace, vSearchSpace, peakProminence, ...
                    FBLn, FBLm, musicOrderThrehsold, maxOrder, decimationFactor);
% ----------------

% #### ESPRIT2D ####
nSubcarriers    = 120;                  % used subcarriers
mSymbols        = 28;                   % used symbols
lagN            = 24;                    % rows in each snapshot
lagM            = 12;                    % columns in each snapshot
